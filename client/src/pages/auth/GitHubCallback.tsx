...
import { githubAuth } from '../../store/slices/authSlice';
...
const GitHubCallback: React.FC = () => {
  ...
  useEffect(() => {
    // Create a function to process the GitHub auth
    const processGitHubAuth = async () => {
      ...
      try {
        ...
        // Dispatch the GitHub auth action
        ...
        setTimeout(() => {
          navigate('/login', { 
            state: { error: err.message || 'GitHub authentication failed' }
          });
        }, 3000);
      } finally {
